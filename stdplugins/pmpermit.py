...
UNIBORG_USER_BOT_NO_WARN = "IT: Ciao!! Sono l'userbot di NeKroSan! Il mio Capo é attualmente occupato/offline. Attendi la sua risposta\n\nEN: Hello!! I'm the NeKroSan userbot! My Leader is currently busy / offline. Wait for his reply"
    ...
    if Config.NO_P_M_SPAM:
        if event.is_private:
            if not is_approved(chat.id):
                ...
                await event.edit("──███▅▄▄▄▄▄▄▄▄▄\n─██▐████████████\n▐█▀████████████▌▌\n▐─▀▀▀▐█▌▀▀███▀█─▌\n▐▄───▄█───▄█▌▄█ \n\n IT: Bene. Hai ricevuto il permesso di messaggiare con il mio Capo!\n\nEN: Well. You have received permission to send messages with my Leader!")
                await asyncio.sleep(3)
                await event.delete()
    ...
    if Config.NO_P_M_SPAM:
        if event.is_private:
            if is_approved(chat.id):
                disapprove(chat.id)
                await event.edit("███████▄▄███████████▄  \n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓███░░░░░░░░░░░░█\n██████▀▀▀█░░░░██████▀  \n░░░░░░░░░█░░░░█  \n░░░░░░░░░░█░░░█  \n░░░░░░░░░░░█░░█  \n░░░░░░░░░░░█░░█  \n░░░░░░░░░░░░▀▀ \n\nIT: Fanculo puttanella, ora non puoi mandarmi messaggi.\n\nEN: Fuck Off Bitch, Now You Can't Message Me.")
                await asyncio.sleep(3)
                await borg(functions.contacts.BlockRequest(chat.id))
